...
public class Student {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return _person.Equals(student._person) && _education == student._education && _group == student._group && Exams.SequenceEqual(student._exams);
    ...
    {
        if (_exams == null) {
            return HashCode.Combine(_person, _education, _group);
        }
        
        return HashCode.Combine(_person, _education, _group,((IStructuralEquatable)_exams).GetHashCode(EqualityComparer<Exam>.Default));
    }
}
